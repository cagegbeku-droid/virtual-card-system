...
// Defensive Error Boundary to guarantee no blank white screen
...
function AfriVisaApp() {
  ...
  // Format dynamic date (e.g., "Current date | 15 May 2024")
  ...
  return (
    ...
    >
      <div>
        {!currentUser ? (
          /* ========================================================================= */
          /* GUEST HERO LANDING: "JUST USE GET STARTED"                                 */
          /* ========================================================================= */
          <div className="max-w-4xl mx-auto px-4 sm:px-8 py-16 sm:py-24 text-center">
            ...
            <p className="text-sm sm:text-base text-slate-400 max-w-xl mx-auto leading-relaxed mb-10">
              Generate 3D-Secure USD Visa cards for OpenAI, AWS, GitHub, Netflix, and international merchants. Load funds instantly with MTN MoMo, Telecel Cash, or AT Money.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              ...
              <button
                ...
                className="w-full sm:w-auto py-3.5 px-6 rounded-xl bg-[#0E131F] hover:bg-[#151D2E] text-slate-300 font-semibold text-xs border border-[#1E293F] transition-colors"
              >
                Exchange Rate: 1 USD = {fxInfo.fx_rate} GHS
              </button>
            </div>
          ...
          /* ========================================================================= */
          /* AUTHENTICATED APP SHELL: MATCHING USER'S IMAGE EXACTLY                     */
          /* ========================================================================= */
            ...
            <main className="flex-1 p-4 sm:p-7 lg:p-8 space-y-6 max-w-7xl mx-auto w-full">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                ...
                <div className="lg:col-span-7 flex flex-col items-center justify-center">
                  ...
                  <div className="flex items-center gap-2.5 mt-4 w-full max-w-[440px] text-xs font-mono">
                    <button
                ...
                <div className="lg:col-span-5 space-y-4">
                  ...
                  <div className="p-5 rounded-2xl bg-[#0E131F] border border-[#192236] shadow-xl">
                    ...
                    <div className="my-2">
                      <span className="text-3xl sm:text-4xl font-black text-[#22D3EE] font-mono tracking-tight drop-shadow-[0_0_15px_rgba(34,211,238,0.4)]">
                        ${Number(activeCard?.balance ?? stats?.total_balance_usd ?? 2450.0).toFixed(2)}
                      </span>
                    </div>
                  ...
                  {/* Quick Top-Up Card (Matching Image) */}
                  <div className="p-5 rounded-2xl bg-[#0E131F] border border-[#192236] shadow-xl space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {/* MTN MoMo Button */}
                      <div className="p-3 rounded-xl bg-[#131929] border border-[#1F293F] flex flex-col justify-between">
                        <div className="flex items-center gap-2 mb-3">
                          <div className="w-7 h-7 rounded-lg bg-yellow-400 text-slate-950 font-bold flex items-center justify-center text-[10px] shadow-sm">
                            MTN
                          </div>
                          <div>
                            <p className="text-xs font-bold text-white">MTN</p>
                            <p className="text-[10px] text-slate-400">MoMo</p>
                          </div>
                        </div>

                        <button
                          onClick={() => handleOpenMoMo('MTN')}
                          className="w-full py-1.5 rounded-lg bg-[#1D263B] hover:bg-yellow-400 hover:text-slate-950 text-slate-200 text-xs font-semibold font-mono transition-colors text-center"
                        >
                          Top Up Now
                        </button>
                      </div>
                      ...
                      <div className="p-3 rounded-xl bg-[#131929] border border-[#1F293F] flex flex-col justify-between">
                        <div className="flex items-center gap-2 mb-3">
                          <div className="w-7 h-7 rounded-lg bg-red-600 text-white font-bold flex items-center justify-center text-[11px] shadow-sm">
                            t
                          </div>
                          <div>
                            <p className="text-xs font-bold text-white">Telecel</p>
                        ...
                        <button
                          ...
                          className="w-full py-1.5 rounded-lg bg-[#1D263B] hover:bg-red-600 hover:text-white text-slate-200 text-xs font-semibold font-mono transition-colors text-center"
                        >
                          Top Up Now
                        </button>
                      </div>
              ...
              {/* BOTTOM: RECENT TRANSACTIONS (SaaS Subscriptions - Matching Image) */}
              <div className="p-5 rounded-2xl bg-[#0E131F] border border-[#192236] shadow-xl space-y-4">
                <div className="flex items-center justify-between text-xs">
                  <span className="font-bold text-slate-200 tracking-wide uppercase font-mono">
                    RECENT TRANSACTIONS (SaaS Subscriptions)
                  </span>
                  <span className="text-slate-500 font-mono text-[11px]">Paystack & Visa Rails</span>
                </div>

                {/* Styled Transaction Rows */}
                <div className="space-y-2 font-mono text-xs">
                  {/* Row 1: OpenAI */}
                  <div className="p-3 rounded-xl bg-[#111624] border border-[#1A2234] flex items-center justify-between hover:bg-[#151B2C] transition-colors">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-bold text-white">OpenAI</p>
                        <p className="text-[11px] text-slate-400">
                          $20.00 | ChatGPT Plus | 12 May 2024
                        </p>
                      </div>
                    </div>
                    <span className="px-2.5 py-0.5 rounded-md text-[10px] font-bold text-emerald-400 border border-emerald-500/40 bg-emerald-500/10">
                      SUCCESS
                    </span>
                  </div>
                  ...
                  <div className="p-3 rounded-xl bg-[#111624] border border-[#1A2234] flex items-center justify-between hover:bg-[#151B2C] transition-colors">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-slate-400">
                          $185.70 | Cloud Services | 10 May 2024
                        </p>
                      </div>
                    </div>
                    <span className="px-2.5 py-0.5 rounded-md text-[10px] font-bold text-emerald-400 border border-emerald-500/40 bg-emerald-500/10">
